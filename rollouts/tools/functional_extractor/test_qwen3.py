#!/usr/bin/env python3
"""Test functional Qwen3 implementation against HuggingFace model.

Run locally (requires GPU):
    python -m tools.functional_extractor.test_qwen3

Run on remote GPU:
    python -m tools.functional_extractor.test_qwen3 --remote
    python -m tools.functional_extractor.test_qwen3 --remote --gpu-id <id>
"""
...
def test_on_gpu():
    ...
    import torch
    from qwen3_functional import qwen3_forward
    from transformers import AutoModelForCausalLM

    print("=" * 60)
    print("Qwen3-0.6B Functional Implementation Test")
    print("=" * 60)
    ...
    def run_dtype_test(name: str, dtype: torch.dtype) -> bool:
        ...
        with torch.no_grad():
            ...
            functional_logits = qwen3_forward(input_ids, weights_typed)

        # Use looser tolerance for fp16/fp32
