...
from rollouts.agents import Actor, rollout, stdout_handler
from rollouts.agents.transform_messages import transform_messages
from rollouts.core import Endpoint, Message, TextContent, ThinkingContent, Trajectory
...
async def test_orphaned_tool_call_handling() -> None:
    ...
    from rollouts.core import ToolCallContent
