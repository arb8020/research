...
async def main():
    """Run all tests."""
    print("=" * 60)
    print("ClaudeCodeEnvironment Tests")
    print("=" * 60)

    # Run unit tests first (no API needed)
    test_trajectory_parsing()
    ...
    if not claude_bin:
        print("\n⚠️  Claude Code CLI not found - skipping integration tests")
    ...
    try:
        await test_environment_protocol()
        await test_streaming_callback()
