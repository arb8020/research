...
def _get_api_key() -> str:
    ...
    if not key:
        raise RuntimeError("ANTHROPIC_API_KEY not set - skipping test")
    return key
...
if __name__ == "__main__":
    ...
    test_token_budget_stops_agent()
    print("PASSED")

    print("Testing cost budget...")
    test_cost_budget_stops_agent()
    print("PASSED")

    print("Testing cost is populated...")
    test_cost_is_populated()
    print("PASSED")
