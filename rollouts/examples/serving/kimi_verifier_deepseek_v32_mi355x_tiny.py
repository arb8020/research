...
Usage:
    python -m argus run --config examples/serving/kimi_verifier_deepseek_v32_mi355x_tiny.py
...
serving_scenario = ServingScenario(
    ...
    output=ServingOutputConfig(
        experiment_name="kimi_verifier_deepseek_v32_mi355x_tiny",
    ),
)
