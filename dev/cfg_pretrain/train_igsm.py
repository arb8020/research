"""Training script for iGSM-based synthetic pretraining.

Usage:
    python train_igsm.py configs/igsm_tiny.py
    python train_igsm.py configs/igsm_small.py
    torchrun --standalone --nproc_per_node=8 train_igsm.py configs/igsm_small.py
"""
...
# Import from rollouts pretrain module (add path before iGSM to avoid conflicts)
...
# Import our iGSM dataloader
from igsm_generator import build_igsm_loader, iGSMConfig
...
def train(
    ...
    """Main training function for iGSM-based pretraining.
    
    Args:
        config: Training configuration
        igsm_config: iGSM-specific configuration
    ...
    # Val loader uses different seed
    ...
    # Model (use config vocab_size which should be 50257 for GPT2)
    if is_main():
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="iGSM-based pretraining")
    ...
    igsm_config = getattr(module, "igsm_config", {})
