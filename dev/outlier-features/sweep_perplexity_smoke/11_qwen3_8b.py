"""Perplexity smoke test - Qwen3-8B.

Quick perplexity computation to validate pipeline on large dense model.
...
# Output
config.output.experiment_name = "perplexity_smoke_qwen3_8b"
