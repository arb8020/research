"""Perplexity smoke test - Qwen3-Next-80B.

Quick perplexity computation to validate pipeline on very large model.
...
# Model: Qwen3-Next-80B (80B total, 3B active)
...
# Output
config.output.experiment_name = "perplexity_smoke_qwen_next_80b"
